...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=dkhopade&repo=python-function-with-git-3",
  "functionName" : "main",
  "includeTap" : true,
  "interfaceType" : "http",
  "projectName" : "python-function-with-git-3"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=dkhopade&repo=python-function-with-git-3'
